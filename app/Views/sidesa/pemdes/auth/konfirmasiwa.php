                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <div class="p-2 mt-4">
                                        ...
                                        <p class="text-muted">Kami segera melakukan verifikasi data registrasi Anda dan mengirimkan kode aktivasi akun Layanan Elektronik Mandiri Desa Anda melalui nomor HP dengan aplikasi (whatsapp) yang telah Anda daftarkan terima kasih.</p>
                                        <div class="mt-4">
