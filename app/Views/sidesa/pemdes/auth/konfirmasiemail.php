                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <div class="p-2 mt-4">
                                        <h4>Registrasi Sukses !</h4>
                                        <p class="text-muted">Kami telah mengirimkan kode token untuk verifikasi email ke alamat email yang anda daftarkan, silahkan akses melalui email anda terima kasih.</p>
                                        <div class="mt-4">
                                            <a href="<?= base_url('user/panel'); ?>" class="btn btn-primary w-100">Kembali ke halaman login</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
