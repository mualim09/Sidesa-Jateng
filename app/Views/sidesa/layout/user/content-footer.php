<footer class="footer">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <span>Copyright &copy; 2020 - <?= date("Y"); ?> Sistem Informasi Desa Prov Jateng</span>
            </div>
        </div>
    </div>
</footer>
...
<?php elseif ($request->uri->getSegment(3) == "role_edit") : ?>
    ...
    <!-- <script src="<?= base_url('minia/js/pages/form-advancedsidesa.init.js'); ?>"></script> buat ada panahnya di dropdown (tapi ada bug) -->
