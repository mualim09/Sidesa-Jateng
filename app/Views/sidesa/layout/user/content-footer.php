    ...
    <script>
        ...
        Highcharts.chart('realisasi_danadesa_reguler_bulanan', {
            ...
            series: [{
                ...
                type: 'column',
                colorByPoint: true,
                data: [<?= $realisasi_bulanan_danadesa_reguler->januari ?>, <?= $realisasi_bulanan_danadesa_reguler->februari ?>, <?= $realisasi_bulanan_danadesa_reguler->maret ?>, <?= $realisasi_bulanan_danadesa_reguler->april ?>, <?= $realisasi_bulanan_danadesa_reguler->mei ?>, <?= $realisasi_bulanan_danadesa_reguler->juni ?>, <?= $realisasi_bulanan_danadesa_reguler->juli ?>, <?= $realisasi_bulanan_danadesa_reguler->agustus ?>, <?= $realisasi_bulanan_danadesa_reguler->september ?>, <?= $realisasi_bulanan_danadesa_reguler->oktober ?>, <?= $realisasi_bulanan_danadesa_reguler->november ?>, <?= $realisasi_bulanan_danadesa_reguler->desember ?>],
                showInLegend: false,
                // dataLabels: {
                //     enabled: true,
        ...
        Highcharts.chart('realisasi_danadesa_bltdd_bulanan', {
            ...
            series: [{
                ...
                type: 'column',
                colorByPoint: true,
                data: [<?= $realisasi_bulanan_danadesa_bltdd->januari ?>, <?= $realisasi_bulanan_danadesa_bltdd->februari ?>, <?= $realisasi_bulanan_danadesa_bltdd->maret ?>, <?= $realisasi_bulanan_danadesa_bltdd->april ?>, <?= $realisasi_bulanan_danadesa_bltdd->mei ?>, <?= $realisasi_bulanan_danadesa_bltdd->juni ?>, <?= $realisasi_bulanan_danadesa_bltdd->juli ?>, <?= $realisasi_bulanan_danadesa_bltdd->agustus ?>, <?= $realisasi_bulanan_danadesa_bltdd->september ?>, <?= $realisasi_bulanan_danadesa_bltdd->oktober ?>, <?= $realisasi_bulanan_danadesa_bltdd->november ?>, <?= $realisasi_bulanan_danadesa_bltdd->desember ?>],
                showInLegend: false,
                // dataLabels: {
                //     enabled: true,
                //     format: 'Rp. {point.y:,.0f}'
        ...
        Highcharts.chart('realisasi_danadesa_kph_bulanan', {
            ...
            series: [{
                ...
                type: 'column',
                colorByPoint: true,
                data: [<?= $realisasi_bulanan_danadesa_kph->januari ?>, <?= $realisasi_bulanan_danadesa_kph->februari ?>, <?= $realisasi_bulanan_danadesa_kph->maret ?>, <?= $realisasi_bulanan_danadesa_kph->april ?>, <?= $realisasi_bulanan_danadesa_kph->mei ?>, <?= $realisasi_bulanan_danadesa_kph->juni ?>, <?= $realisasi_bulanan_danadesa_kph->juli ?>, <?= $realisasi_bulanan_danadesa_kph->agustus ?>, <?= $realisasi_bulanan_danadesa_kph->september ?>, <?= $realisasi_bulanan_danadesa_kph->oktober ?>, <?= $realisasi_bulanan_danadesa_kph->november ?>, <?= $realisasi_bulanan_danadesa_kph->desember ?>],
                showInLegend: false,
                // dataLabels: {
                //     enabled: true,
                //     format: 'Rp. {point.y:,.0f}'
        ...
        Highcharts.chart('realisasi_danadesa_covid_bulanan', {
            ...
            series: [{
                ...
                type: 'column',
                colorByPoint: true,
                data: [<?= $realisasi_bulanan_danadesa_covid->januari ?>, <?= $realisasi_bulanan_danadesa_covid->februari ?>, <?= $realisasi_bulanan_danadesa_covid->maret ?>, <?= $realisasi_bulanan_danadesa_covid->april ?>, <?= $realisasi_bulanan_danadesa_covid->mei ?>, <?= $realisasi_bulanan_danadesa_covid->juni ?>, <?= $realisasi_bulanan_danadesa_covid->juli ?>, <?= $realisasi_bulanan_danadesa_covid->agustus ?>, <?= $realisasi_bulanan_danadesa_covid->september ?>, <?= $realisasi_bulanan_danadesa_covid->oktober ?>, <?= $realisasi_bulanan_danadesa_covid->november ?>, <?= $realisasi_bulanan_danadesa_covid->desember ?>],
                showInLegend: false,
                // dataLabels: {
                //     enabled: true,
                //     format: 'Rp. {point.y:,.0f}'
