...
<div class="page-content">
    <div class="container-fluid">
        ...
        if ($open == 1 or $_SERVER['REMOTE_ADDR'] == '36.72.214.213' or $_SERVER['REMOTE_ADDR'] == '103.246.107.2') {
            echo form_open_multipart('user/import/importidm');
        ?>
                ...
                <div class="col-xl-12">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0" style="font-size: medium;">
                            ...
                            <input hidden type="text" class="form-control" id="nmdata" name="nmdata" value="Indeks Desa Membangun (IDM)" readonly>
