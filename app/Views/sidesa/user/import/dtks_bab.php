...
<div class="page-content">
    <div class="container-fluid">
        ...
        if ($open == 1 or $_SERVER['REMOTE_ADDR'] == '36.72.214.213' or $_SERVER['REMOTE_ADDR'] == '103.246.107.2') {
            echo form_open_multipart('user/import/importdtksbab');
        ?>
                ...
                <div class="col-xl-12">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0" style="font-size: medium;">
                            ...
                            <?php if ($request->uri->getSegment(3) == "dtks_bab_I") : ?>
                                <input hidden type="text" class="form-control" id="nmdata" name="nmdata" value="DTKS BAB I" readonly>
                            ...
                            <?php elseif ($request->uri->getSegment(3) == "dtks_bab_II") : ?>
                                <input hidden type="text" class="form-control" id="nmdata" name="nmdata" value="DTKS BAB II" readonly>
                                <input hidden type="text" class="form-control" id="uploadby" name="uploadby" value="<?= $user['nama']; ?>" readonly>
                                <input hidden type="text" class="form-control" id="image" name="image" value="<?= $user['image']; ?>" readonly>
                                <tr>
                                    <th class="col-xl-2" scope="row">Akan diinput oleh</th>
                            ...
                            <?php elseif ($request->uri->getSegment(3) == "dtks_bab_III") : ?>
                                <input hidden type="text" class="form-control" id="nmdata" name="nmdata" value="DTKS BAB III" readonly>
                                <input hidden type="text" class="form-control" id="uploadby" name="uploadby" value="<?= $user['nama']; ?>" readonly>
                                <input hidden type="text" class="form-control" id="image" name="image" value="<?= $user['image']; ?>" readonly>
                                <tr>
                                    <th class="col-xl-2" scope="row">Akan diinput oleh</th>
                            ...
                            <?php elseif ($request->uri->getSegment(3) == "dtks_bab_IV") : ?>
                                <input hidden type="text" class="form-control" id="nmdata" name="nmdata" value="DTKS BAB IV" readonly>
                                <input hidden type="text" class="form-control" id="uploadby" name="uploadby" value="<?= $user['nama']; ?>" readonly>
                                <input hidden type="text" class="form-control" id="image" name="image" value="<?= $user['image']; ?>" readonly>
                                <tr>
                                    <th class="col-xl-2" scope="row">Akan diinput oleh</th>
