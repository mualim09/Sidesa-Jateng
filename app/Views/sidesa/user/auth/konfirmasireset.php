                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <div class="p-2 mt-4">
                                        ...
                                        <p class="text-muted">Kami telah mengirimkan kode token untuk reset password ke alamat email yang anda daftarkan, silahkan akses melalui email anda terima kasih.</p>
                                        <div class="mt-4">
