...
<div class="page-content">
    <div class="container-fluid">
        ...
        <?php if (isset($danadesa['danadesa'], $jumlah_realisasi) && $jumlah_realisasi < $jumlah_salur_reg) : ?>
            <table>
                <tr>
            ...
            <form action="" method="POST">
                ...
                <table class="table table-hover table-sm mt-3">
                    ...
                    <tbody>
                        <tr>
                            <th scope="col" style="text-align: center; vertical-align: middle;"><?= number_format($jumlah_salur_reg, 0, '', '.'); ?></th>
                            <td scope="col" <?php if ($jumlah_salur_reg > $jumlah_realisasi) : ?> style="color: red; vertical-align: middle; text-align: center;" <?php elseif ($jumlah_salur_reg == $jumlah_realisasi) : ?> style="color: green; vertical-align: middle; text-align: center;" <?php else : ?> style="color:goldenrod; vertical-align: middle; text-align: center;" <?php endif; ?> /><?= number_format($jumlah_realisasi, 0, '', '.'); ?></td>
        ...
        <?php else : ?>
            <div class="text-center mt-4">
                <h3 style="color: crimson;">HARAP INPUT SALUR REGULER TERLEBIH DAHULU</h3>
            </div>
        <?php endif; ?>
