...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row justify-content-center mb-4">
            <div class="col-md-6">
                <form action="<?= base_url('user/admin/role_management'); ?>" method="POST">
                    <?= csrf_field() ?>
        ...
        <div class="col table-responsive">
            <table>
                <tr>
                    ...
                    <td>
                        <a class="nav-link" href="<?= base_url('user/admin/hapussessionkeyword'); ?>">
                    ...
                    <?php foreach ($getrole as $gr) : ?>
                        <tr userid="<?= $gr['user_id']; ?>" nip="<?= $gr['nip']; ?>">
                            ...
                            <td align="center" style="vertical-align: middle;">
                                <a href="<?= base_url('user/admin/role_edit/' . $gr['user_id']) . '/' . $gr['kd_wilayah'] ?>" class="badge bg-info">Edit</a>
                                <a href="<?= base_url('user/admin/role_access/' . $gr['role_id']) ?>" class="badge bg-warning">Configure</a>
