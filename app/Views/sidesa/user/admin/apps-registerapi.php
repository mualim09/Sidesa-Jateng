...
<div class="page-content">
    <div class="container-fluid">
        ...
        <h4 class="mb-4 text-gray text-center">Daftar Registrasi User API Sistem Informasi Desa Provinsi Jawa Tengah</h4>
        ...
        <div class="col table-responsive">
            ...
            <div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="<?= base_url('user/admin/register_api'); ?>" method="POST">
                            <?= csrf_field() ?>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <a class="nav-link" href="<?= base_url('user/admin/hapussessionkeywordapi'); ?>">
