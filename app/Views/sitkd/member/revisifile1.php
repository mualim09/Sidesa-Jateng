    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="embed-responsive embed-responsive-16by9" style="height:800px;">
                <iframe class="pdf-preview" <?php if ($dokumen['file1'] != null) : ?>src="<?= base_url('data/sitkd/file/laporanpdf/' . $pdf) ?>" <?php else : ?> src="<?= base_url('sitkd/auth/blockedakses') ?>" <?php endif; ?> allowfullscreen></iframe>
            </div>
            <hr>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <a href="#"><?= $pemeriksa[0]; ?></a>
                    </div>
                    <div class="form-group">
                        <label>Keterangan</label>
                        <input type="text" readonly class="form-control" value="<?= $keteranganexp[0]; ?>">
                    </div>
                    <form action="" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                        <?php if ($dokumen['file1'] != null && $statusuraian[0] == "revisi") : ?>
                            <input type="file" class="form-control-file mt-4 mb-5" id="file1" name="file1">
                            <!-- <input type="file" class="form-control-file mt-4 mb-5" id="file" name="file1" onchange="previewPDF()"> buat pas upgrade CI4 saja-->
                            <small class="form-text text-danger"><?= $validation->getError('file1'); ?></small>
                            <div class="form-group">
                                <label for="catatan">Catatan dari Kabupaten</label>
                                <textarea class="form-control" name="catatan1" id="catatan1" rows="4"><?= $catatan_member[0]; ?></textarea>
                            ...
                            <div class="form-group">
                                <input type="hidden" class="form-control" id="tanggal_revisi1" name="tanggal_revisi1" value=<?= time(); ?>>
                            ...
                            <div class="form-group">
                                <input type="hidden" class="form-control" id="status_uraian1" name="status_uraian1" value="pending">
                            ...
                            <div class="form-group">
                                <input type="hidden" class="form-control" id="keterangan1" name="keterangan1" value="sesuai">
                            ...
                            <div class="form-group">
                                <?php if ($dokumen['status_laporan'] == "pending") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="File Revisi Persyaratan 1 baru!">
                                <?php elseif ($dokumen['status_laporan'] == "review") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil Revisi Persyaratan 1 review">
                                <?php elseif ($dokumen['status_laporan'] == "peninjauan") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil Revisi Persyaratan 1 peninjauan">
                                <?php endif; ?>
