    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="embed-responsive embed-responsive-16by9" style="height:800px;">
                <iframe <?php if ($dokumen['file4'] != null) : ?>src="<?= base_url('data/sitkd/file/laporanpdf/' . $pdf) ?>" <?php else : ?> src="<?= base_url('sitkd/auth/blockedakses') ?>" <?php endif; ?> allowfullscreen></iframe>
            </div>
            <hr>
        </div>
        <!-- kolom side Widget -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" readonly class="form-control" value="<?php if ($pemeriksa[3] != "") : ?><?= $pemeriksa[3]; ?><?php else : ?> Belum diperiksa PEMPROV <?php endif; ?>">
                    </div>
                    <div class="form-group">
