    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col">
                ...
                <table class="table table-borderless table-sm mt-3">
                    <tbody>
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td width="40%">
                                <input autofocus type="text" class="form-control form-control-sm" id="kecamatan" name="kecamatan" value="<?= old('kecamatan'); ?>">
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td width="40%">
                                <input type="text" class="form-control form-control-sm" id="desa" name="desa" value="<?= old('desa'); ?>">
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td width="40%">
                                <input type="text" class="form-control form-control-sm" id="nama_trans" name="nama_trans" value="<?= old('nama_trans'); ?>">
                            ...
                            <td>
                                <div class="input-group input-group-sm" style="width: 30%;">
                                    <input type="text" readonly class="form-control text-center" id="kode" name="kode" placeholder="..." value="<?= old('kode'); ?>">
                                    <input type="text" hidden readonly class="form-control" id="jenis" name="jenis" value="<?= old('jenis'); ?>">
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td width="40%">
                                <input type="text" class="form-control form-control-sm" id="m2" name="luas_tkd" value="<?= old('luas_tkd'); ?>">
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td width="40%">
                                <input type="text" class="form-control form-control-sm" id="m21" name="pengganti" value="<?= old('pengganti'); ?>">
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td width="40%">
                                <input type="text" class="form-control form-control-sm" id="rupiah" name="ugr" value="<?= old('ugr'); ?>">
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td width="40%">
                                <input type="text" class="form-control form-control-sm" id="rupiah1" name="sisa_ugr" value="<?= old('sisa_ugr'); ?>">
                ...
                <table class="table table-hover table-sm mt-3 mb-5">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: right;">Sub Kategori : Umum</th>
                        </tr>
                    </thead>
                </table>
                ...
                <div class="form-group">
                    <input type="hidden" readonly name="subkategori" class="form-control" id="subkategori" value="Umum">
                ...
                <div class="form-group">
                    <input type="hidden" readonly class="form-control-plaintext" name="statusfile" id="statusfile" value="pending^pending^pending^pending^pending^pending^pending^pending^pending^pending^pending^pending^pending^sukses^sukses^sukses">
