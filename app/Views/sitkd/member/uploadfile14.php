                ...
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="tanggalupload14" name="tanggalupload14" value=<?= time(); ?>>
                        ...
                        <div class="form-group">
                            <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="File Persyaratan 14 baru!">
                        ...
                        <?php if ($dokumen['file14'] == null && $dokumen['subkategori'] == 'Bukan kepentingan umum') : ?>
