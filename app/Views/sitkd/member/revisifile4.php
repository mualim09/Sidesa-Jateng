    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <table class="table table-borderless table-sm">
                <?php foreach ($geturaian as $gu) : ?>
                    ...
                    <tr>
                        <th width="68%">Diperiksa dari PEMPROV pada tanggal <?php if ($tanggal_review[3] != "") : ?><?= date("d/m/Y", $tanggal_review[3]); ?><?php else : ?> - <?php endif; ?></th>
        ...
        <div class="col-lg-8">
            <div class="embed-responsive embed-responsive-16by9" style="height:800px;">
                <iframe class="pdf-preview" <?php if ($dokumen['file4'] != null) : ?>src="<?= base_url('data/sitkd/file/laporanpdf/' . $pdf) ?>" <?php else : ?> src="<?= base_url('sitkd/auth/blockedakses') ?>" <?php endif; ?> allowfullscreen></iframe>
            </div>
            <hr>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <a href="#"><?= $pemeriksa[3]; ?></a>
                    </div>
                    <div class="form-group">
                        <label>Keterangan</label>
                        <input type="" readonly class="form-control" value="<?= $keteranganexp[3]; ?>">
                    </div>
                    <form action="" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                        <?php if ($dokumen['file4'] != null && $statusuraian[3] == "revisi") : ?>
                            <input type="file" class="form-control-file mt-4 mb-5" id="file4" name="file4">
                            <!-- <input type="file" class="form-control-file mt-4 mb-5" id="file" name="file4" onchange="previewPDF()"> buat pas upgrade CI4 saja> -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="tanggal_revisi4" name="tanggal_revisi4" value=<?= time(); ?>>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="status_uraian4" name="status_uraian4" value="pending">
                            ...
                            <div class="form-group">
                                <?php if ($dokumen['status_laporan'] == "pending") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="File Revisi Persyaratan 4 baru!">
                                <?php elseif ($dokumen['status_laporan'] == "review") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil Revisi Persyaratan 4 review">
                                <?php elseif ($dokumen['status_laporan'] == "peninjauan") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil Revisi Persyaratan 4 peninjauan">
                                <?php endif; ?>
