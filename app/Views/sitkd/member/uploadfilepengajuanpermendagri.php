        ...
        <div class="row">
            <div class="col">
                ...
                <table class="table table-hover table-sm mt-3 mb-5">
                    <thead>
                        <tr>
                            <th>Kategori : PERMENDAGRI No. 4 / 2007</th>
                            <th style="text-align: right;">Sub Kategori : PERMENDAGRI No. 4 / 2007</th>
                        </tr>
                    </thead>
                </table>
                ...
                <div class="form-group">
                    <input type="hidden" readonly name="kategori" class="form-control" id="kategori" value="PERMENDAGRI No. 4 / 2007">
                    <small class="form-text text-danger"><?= $validation->getError('kategori'); ?></small>
                </div>
                <div class="form-group">
                    <input type="hidden" readonly name="subkategori" class="form-control" id="subkategori" value="PERMENDAGRI No. 4 / 2007">
                ...
                <div class="form-group">
                    <input type="hidden" readonly class="form-control-plaintext" name="statusfile" id="statusfile" value="pending^pending^pending^pending^pending^pending^pending^pending^pending^pending^sukses^sukses^sukses^sukses^sukses^sukses">
