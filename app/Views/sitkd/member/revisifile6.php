    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <table class="table table-borderless table-sm">
                <?php foreach ($geturaian as $gu) : ?>
                    ...
                    <tr>
                        <th width="68%">Direvisi dari PEMKAB pada tanggal <?php if ($tanggal_revisi[5] != "") : ?><?= date("d/m/Y", $tanggal_revisi[5]); ?><?php else : ?> - <?php endif; ?></th>
                        <th style=" text-align: left;" width="30px">Kecamatan</th>
                        <th style=" text-align: left;" width="10px">:</th>
                        <th style=" text-align: left;"><?= $gu['kecamatan']; ?></th>
                    </tr>
                    <tr>
                        <th width="68%">Diperiksa dari PEMPROV pada tanggal <?php if ($tanggal_review[5] != "") : ?><?= date("d/m/Y", $tanggal_review[5]); ?><?php else : ?> - <?php endif; ?></th>
        ...
        <div class="col-lg-8">
            <div class="embed-responsive embed-responsive-16by9" style="height:800px;">
                <iframe class="pdf-preview" <?php if ($dokumen['file6'] != null) : ?>src="<?= base_url('data/sitkd/file/laporanpdf/' . $pdf) ?>" <?php else : ?> src="<?= base_url('sitkd/auth/blockedakses') ?>" <?php endif; ?> allowfullscreen></iframe>
            </div>
            <hr>
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    <dl class="row">
                        ...
                        <dd class="col text-right" style="<?php if ($statusuraian[5] == "sukses") : ?> color:#00cc00 <?php elseif ($statusuraian[5] == "revisi") : ?> color:red <?php else : ?> color:black <?php endif; ?>" class="text-right"><i><?= $statusuraian[5]; ?></i>
                        </dd>
                    </dl>
                </div>
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <a href="#"><?= $pemeriksa[5]; ?></a>
                    </div>
                    <div class="form-group">
                        <label>Keterangan</label>
                        <input type="" readonly class="form-control" value="<?= $keteranganexp[5]; ?>">
                    </div>
                    <form action="" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                        <?php if ($dokumen['file6'] != null && $statusuraian[5] == "revisi") : ?>
                            <input type="file" class="form-control-file mt-4 mb-5" id="file6" name="file6">
                            <!-- <input type="file" class="form-control-file mt-4 mb-5" id="file" name="file6" onchange="previewPDF()"> buat pas upgrade CI4 saja> -->
                            <small class="form-text text-danger"><?= $validation->getError('file6'); ?></small>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="catatan6" id="catatan6" rows="4"><?= $catatan_member[5]; ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="tanggal_revisi6" name="tanggal_revisi6" value=<?= time(); ?>>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="status_uraian6" name="status_uraian6" value="pending">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="keterangan6" name="keterangan6" value="sesuai">
                            ...
                            <div class="form-group">
                                <?php if ($dokumen['status_laporan'] == "pending") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="File Revisi Persyaratan 6 baru!">
                                <?php elseif ($dokumen['status_laporan'] == "review") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil Revisi Persyaratan 6 review">
                                <?php elseif ($dokumen['status_laporan'] == "peninjauan") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil Revisi Persyaratan 6 peninjauan">
                                <?php endif; ?>
