    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="embed-responsive embed-responsive-16by9" style="height:800px;">
                <iframe class="pdf-preview" <?php if ($dokumen['file16'] != null) : ?>src="<?= base_url('data/sitkd/file/laporanpdf/' . $pdf) ?>" <?php else : ?> src="<?= base_url('sitkd/auth/blockedakses') ?>" <?php endif; ?> allowfullscreen></iframe>
            </div>
            <hr>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <a href="#"><?= $pemeriksa[15]; ?></a>
                    </div>
                    <div class="form-group">
                        <label>Keterangan</label>
                        <input type="" readonly class="form-control" value="<?= $keteranganexp[15]; ?>">
                    </div>
                    <form action="" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                        <?php if ($dokumen['file16'] != null && $statusuraian[15] == "revisi") : ?>
                            <input type="file" class="form-control-file mt-4 mb-5" id="file16" name="file16">
                            <!-- <input type="file" class="form-control-file mt-4 mb-5" id="file" name="file16" onchange="previewPDF()"> buat pas upgrade CI4 saja> -->
                            <small class="form-text text-danger"><?= $validation->getError('file16'); ?></small>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="catatan16" id="catatan16" rows="4"><?= $catatan_member[15]; ?></textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="tanggal_revisi16" name="tanggal_revisi16" value=<?= time(); ?>>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="status_uraian16" name="status_uraian16" value="pending">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="keterangan16" name="keterangan16" value="sesuai">
                            ...
                            <div class="form-group">
                                <?php if ($dokumen['status_laporan'] == "pending") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="File Revisi Persyaratan 16 baru!">
                                <?php elseif ($dokumen['status_laporan'] == "review") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil Revisi Persyaratan 16 review">
                                <?php elseif ($dokumen['status_laporan'] == "peninjauan") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil Revisi Persyaratan 16 peninjauan">
                                <?php endif; ?>
