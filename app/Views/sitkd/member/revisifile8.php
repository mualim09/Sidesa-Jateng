    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <table class="table table-borderless table-sm">
                <?php foreach ($geturaian as $gu) : ?>
                    ...
                    <tr>
                        <th width="68%">Direvisi dari PEMKAB pada tanggal <?php if ($tanggal_revisi[7] != "") : ?><?= date("d/m/Y", $tanggal_revisi[7]); ?><?php else : ?> - <?php endif; ?></th>
                        <th style=" text-align: left;" width="30px">Kecamatan</th>
                        <th style=" text-align: left;" width="10px">:</th>
                        <th style=" text-align: left;"><?= $gu['kecamatan']; ?></th>
                    </tr>
                    <tr>
                        <th width="68%">Diperiksa dari PEMPROV pada tanggal <?php if ($tanggal_review[7] != "") : ?><?= date("d/m/Y", $tanggal_review[7]); ?><?php else : ?> - <?php endif; ?></th>
        ...
        <div class="col-lg-8">
            <div class="embed-responsive embed-responsive-16by9" style="height:800px;">
                <iframe class="pdf-preview" <?php if ($dokumen['file8'] != null) : ?>src="<?= base_url('data/sitkd/file/laporanpdf/' . $pdf) ?>" <?php else : ?> src="<?= base_url('sitkd/auth/blockedakses') ?>" <?php endif; ?> allowfullscreen></iframe>
            </div>
            <hr>
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    <dl class="row">
                        ...
                        <dd class="col text-right" style="<?php if ($statusuraian[7] == "sukses") : ?> color:#00cc00 <?php elseif ($statusuraian[7] == "revisi") : ?> color:red <?php else : ?> color:black <?php endif; ?>" class="text-right"><i><?= $statusuraian[7]; ?></i>
                        </dd>
                    </dl>
                </div>
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <a href="#"><?= $pemeriksa[7]; ?></a>
                    </div>
                    <div class="form-group">
                        <label>Keterangan</label>
                        <input type="" readonly class="form-control" value="<?= $keteranganexp[7]; ?>">
                    </div>
                    <form action="" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                        <?php if ($dokumen['file8'] != null && $statusuraian[7] == "revisi") : ?>
                            <input type="file" class="form-control-file mt-4 mb-5" id="file8" name="file8">
                            <!-- <input type="file" class="form-control-file mt-4 mb-5" id="file" name="file8" onchange="previewPDF()"> buat pas upgrade CI4 saja> -->
                            <small class="form-text text-danger"><?= $validation->getError('file8'); ?></small>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="catatan8" id="catatan8" rows="4"><?= $catatan_member[7]; ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="tanggal_revisi8" name="tanggal_revisi8" value=<?= time(); ?>>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="status_uraian8" name="status_uraian8" value="pending">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="keterangan8" name="keterangan8" value="sesuai">
                            ...
                            <div class="form-group">
                                <?php if ($dokumen['status_laporan'] == "pending") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="File Revisi Persyaratan 8 baru!">
                                <?php elseif ($dokumen['status_laporan'] == "review") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil Revisi Persyaratan 8 review">
                                <?php elseif ($dokumen['status_laporan'] == "peninjauan") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil Revisi Persyaratan 8 peninjauan">
                                <?php endif; ?>
