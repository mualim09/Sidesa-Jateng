                ...
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="tanggalupload9" name="tanggalupload9" value=<?= time(); ?>>
                        ...
                        <div class="form-group">
                            <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="File Persyaratan 9 baru!">
                        ...
                        <?php if ($dokumen['file9'] == null && $dokumen['subkategori'] == 'Umum') : ?>
                            <button type="submit" name="proses" class="btn btn-primary float-right mt-2">Save</button>
                        <?php elseif ($dokumen['file9'] == null && $dokumen['subkategori'] == 'Bukan kepentingan umum') : ?>
                            <button type="submit" name="proses" class="btn btn-primary float-right mt-2">Save</button>
                        <?php elseif ($dokumen['file9'] == null && $dokumen['subkategori'] == 'PERMENDAGRI No. 4 / 2007') : ?>
                            <button type="submit" name="proses" class="btn btn-primary float-right mt-2">Save</button>
                        <?php elseif ($dokumen['file9'] == null && $dokumen['subkategori'] == 'Tanah pengganti') : ?>
                            <button type="submit" name="proses" class="btn btn-primary float-right mt-2">Save</button>
                        <?php endif; ?>
                    </form>
                </div>
