                ...
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="tanggalupload16" name="tanggalupload16" value=<?= time(); ?>>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="File Persyaratan 16 baru!">
                        ...
                        <?php if ($dokumen['file16'] == null && $dokumen['subkategori'] == 'Bukan kepentingan umum') : ?>
