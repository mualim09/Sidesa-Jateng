    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col">
                ...
                <table class="table table-hover table-sm mt-3 mb-5">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: right;">Sub Kategori : Tanah pengganti</th>
                        </tr>
                    </thead>
                </table>
                ...
                <div class="form-group">
                    <input type="hidden" readonly name="subkategori" class="form-control" id="subkategori" value="Tanah pengganti">
