    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="embed-responsive embed-responsive-16by9" style="height:800px;">
                <iframe class="pdf-preview" <?php if ($dokumen['file9'] != null) : ?>src="<?= base_url('data/sitkd/file/laporanpdf/' . $pdf) ?>" <?php else : ?> src="<?= base_url('sitkd/auth/blockedakses') ?>" <?php endif; ?> allowfullscreen></iframe>
            </div>
            <hr>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <a href="#"><?= $pemeriksa[8]; ?></a>
                    </div>
                    <div class="form-group">
                        <label>Keterangan</label>
                        <input type="" readonly class="form-control" value="<?= $keteranganexp[8]; ?>">
                    </div>
                    <form action="" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                        <?php if ($dokumen['file9'] != null && $statusuraian[8] == "revisi") : ?>
                            <input type="file" class="form-control-file mt-4 mb-5" id="file9" name="file9">
                            <!-- <input type="file" class="form-control-file mt-4 mb-5" id="file" name="file9" onchange="previewPDF()"> buat pas upgrade CI4 saja> -->
                            <small class="form-text text-danger"><?= $validation->getError('file9'); ?></small>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="catatan9" id="catatan9" rows="4"><?= $catatan_member[8]; ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="tanggal_revisi9" name="tanggal_revisi9" value=<?= time(); ?>>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="status_uraian9" name="status_uraian9" value="pending">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="keterangan9" name="keterangan9" value="sesuai">
                            ...
                            <div class="form-group">
                                <?php if ($dokumen['status_laporan'] == "pending") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="File Revisi Persyaratan 9 baru!">
                                <?php elseif ($dokumen['status_laporan'] == "review") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil Revisi Persyaratan 9 review">
                                <?php elseif ($dokumen['status_laporan'] == "peninjauan") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil Revisi Persyaratan 9 peninjauan">
                                <?php endif; ?>
