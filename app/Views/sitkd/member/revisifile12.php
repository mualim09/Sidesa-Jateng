    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="embed-responsive embed-responsive-16by9" style="height:800px;">
                <iframe class="pdf-preview" <?php if ($dokumen['file12'] != null) : ?>src="<?= base_url('data/sitkd/file/laporanpdf/' . $pdf); ?>" <?php else : ?> src="<?= base_url('sitkd/auth/blockedakses') ?>" <?php endif; ?> allowfullscreen></iframe>
            </div>
            <hr>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <a href="#"><?= $pemeriksa[11]; ?></a>
                    </div>
                    <div class="form-group">
                        <label>Keterangan</label>
                        <input type="" readonly class="form-control" value="<?= $keteranganexp[11]; ?>">
                    </div>
                    <form action="" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                        <?php if ($dokumen['file12'] != null && $statusuraian[11] == "revisi") : ?>
                            <input type="file" class="form-control-file mt-4 mb-5" id="file12" name="file12">
                            <!-- <input type="file" class="form-control-file mt-4 mb-5" id="file" name="file12" onchange="previewPDF()"> buat pas upgrade CI4 saja> -->
                            <small class="form-text text-danger"><?= $validation->getError('file12'); ?></small>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="catatan12" id="catatan12" rows="4"><?= $catatan_member[11]; ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="tanggal_revisi12" name="tanggal_revisi12" value=<?= time(); ?>>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="status_uraian12" name="status_uraian12" value="pending">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="keterangan12" name="keterangan12" value="sesuai">
                            ...
                            <div class="form-group">
                                <?php if ($dokumen['status_laporan'] == "pending") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="File Revisi Persyaratan 12 baru!">
                                <?php elseif ($dokumen['status_laporan'] == "review") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil Revisi Persyaratan 12 review">
                                <?php elseif ($dokumen['status_laporan'] == "peninjauan") : ?>
                                    <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil Revisi Persyaratan 12 peninjauan">
                                <?php endif; ?>
