            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="hidden" class="form-control" id="tanggalupload1" name="tanggalupload1" value=<?= time(); ?>>
                        ...
                        <div class="form-group">
                            <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="File Persyaratan 1 baru!">
