        ...
        <div class="col-lg-12">
            ...
            <table class="table table-borderless table-sm" style="overflow-x:auto;">
                <?php foreach ($geturaian as $gu) : ?>
                    <tr>
                        <th width="68%">Diupload dari Pemkab pada tanggal <?= $tanggal_upload[6] != '' ? date("d/m/Y", $tanggal_upload[6]) : '-'; ?></th>
                        <th style=" text-align: left;" width="30px">Desa</th>
                        <th style=" text-align: left;" width="10px">:</th>
                        <th style=" text-align: left;"><?= $gu['desa']; ?></th>
                    </tr>
                    <tr>
                        <th width="68%">Direvisi dari PEMKAB pada tanggal <?= $tanggal_upload[6] != '' ? date("d/m/Y", $tanggal_upload[6]) : '-'; ?></th>
