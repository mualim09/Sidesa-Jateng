        ...
        <div class="col-lg-12">
            ...
            <table class="table table-borderless table-sm" style="overflow-x:auto;">
                <?php foreach ($geturaian as $gu) : ?>
                    <tr>
                        <th width="68%">Diupload dari Pemkab pada tanggal <?= $tanggal_upload[15] != '' ? date("d/m/Y", $tanggal_upload[15]) : '-'; ?></th>
                        <th style=" text-align: left;" width="30px">Desa</th>
                        <th style=" text-align: left;" width="10px">:</th>
                        <th style=" text-align: left;"><?= $gu['desa']; ?></th>
                    </tr>
                    <tr>
                        <th width="68%">Direvisi dari PEMKAB pada tanggal <?= $tanggal_upload[15] != '' ? date("d/m/Y", $tanggal_upload[15]) : '-'; ?></th>
                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" id="pemeriksa16" name="pemeriksa16" value="<?= $user['nama']; ?>">
                        </div>
                        <div class="form-group mb-5">
                            <label>Keterangan</label>
                            <div class="input-group input-group-sm">
                                <?php if ($dokumen['file16'] != null) : ?>
                                    <input type="text" readonly class="form-control text-center" id="keterangan16" name="keterangan16" placeholder="..." value="<?= set_value('keterangan16'); ?>">
                                    <input type="text" readonly class="form-control text-center" id="statusuraian16" name="statusuraian16" placeholder="..." value="<?= set_value('statusuraian16'); ?>">
                            ...
                            <small class="form-text text-danger"><?= $validation->getError('keterangan16'); ?></small>
                        ...
                        <div class="form-group" <?php if ($catatan_member[15] == "") : ?> hidden <?php endif; ?>>
                            ...
                            <textarea class="form-control" disabled name="catatan_member" id="catatan_member" style="font-style: italic;" rows="4"><?= $catatan_member[15]; ?></textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="tanggal_review16" name="tanggal_review16" value=<?= time(); ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil verifikasi Persyaratan 16 baru!">
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive">
                <table class="table table-hover table-bordered table-sm" id="reviewfiles16">
                    <thead>
                    ...
                    <tbody>
                        <?php foreach ($rfiles as $rf) : ?>
                            <tr id="reviewers16" data-ket="<?= $rf['atrketerangan']; ?>" data-sta="<?= $rf['atrstatusuraian']; ?>">
