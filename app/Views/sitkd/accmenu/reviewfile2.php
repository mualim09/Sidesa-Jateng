        ...
        <div class="col-lg-12">
            ...
            <table class="table table-borderless table-sm" style="overflow-x:auto;">
                <?php foreach ($geturaian as $gu) : ?>
                    <tr>
                        <th width="68%">Diupload dari Pemkab pada tanggal <?= $tanggal_upload[1] != '' ? date("d/m/Y", $tanggal_upload[1]) : '-'; ?></th>
                        <th style=" text-align: left;" width="30px">Desa</th>
                        <th style=" text-align: left;" width="10px">:</th>
                        <th style=" text-align: left;"><?= $gu['desa']; ?></th>
                    </tr>
                    <tr>
                        <th width="68%">Direvisi dari PEMKAB pada tanggal <?= $tanggal_upload[1] != '' ? date("d/m/Y", $tanggal_upload[1]) : '-'; ?></th>
                ...
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" id="pemeriksa2" name="pemeriksa2" value="<?= $user['nama']; ?>">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <div class="input-group input-group-sm">
                                <?php if ($dokumen['file2'] != null) : ?>
                                    <input type="text" readonly class="form-control text-center" id="keterangan2" name="keterangan2" placeholder="..." value="<?= set_value('keterangan2'); ?>">
                                    <input type="text" readonly class="form-control text-center" id="statusuraian2" name="statusuraian2" placeholder="..." value="<?= set_value('statusuraian2'); ?>">
                            ...
                            <small class="form-text text-danger"><?= $validation->getError('keterangan2'); ?></small>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="tanggal_review2" name="tanggal_review2" value=<?= time(); ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil verifikasi Persyaratan 2 baru!">
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive">
                <table class="table table-hover table-bordered table-sm" id="reviewfiles2">
                    <thead>
                    ...
                    <tbody>
                        <?php foreach ($rfiles as $rf) : ?>
                            <tr id="reviewers2" data-ket="<?= $rf['atrketerangan']; ?>" data-sta="<?= $rf['atrstatusuraian']; ?>">
