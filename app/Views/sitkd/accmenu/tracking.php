                            ...
                            <blockquote>
                                ...
                                <dl class="row mt-4">
                                    ...
                                    <?php if ($dokumen['upload_persetujuan'] != null) : ?>
                                        <dd class="blockquote-small col text-right"><a href="<?= base_url('sitkd/accmenu/viewpersetujuan'); ?>/<?= $dokumen['file_id']; ?>" class="badge badge-success">Dokumen persetujuan</a></dd>
                                    <?php elseif ($dokumen['upload_persetujuan'] == null && $dokumen['status_laporan'] == 'sukses') : ?>
                                        <dd class="blockquote-small col text-right"><a href="<?= base_url('sitkd/accmenu/uploadpersetujuan'); ?>/<?= $dokumen['file_id']; ?>/<?= $dokumen['tanggal']; ?>" class="badge badge-danger">Upload Dokumen Persetujuan</a></dd>
                                    <?php endif; ?>
                                </dl>
                            </blockquote>
                        </div>
