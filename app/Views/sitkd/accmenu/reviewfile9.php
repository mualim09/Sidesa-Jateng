        ...
        <div class="col-lg-12">
            ...
            <table class="table table-borderless table-sm" style="overflow-x:auto;">
                <?php foreach ($geturaian as $gu) : ?>
                    <tr>
                        <th width="68%">Diupload dari Pemkab pada tanggal <?= $tanggal_upload[8] != '' ? date("d/m/Y", $tanggal_upload[8]) : '-'; ?></th>
                        <th style=" text-align: left;" width="30px">Desa</th>
                        <th style=" text-align: left;" width="10px">:</th>
                        <th style=" text-align: left;"><?= $gu['desa']; ?></th>
                    </tr>
                    <tr>
                        <th width="68%">Direvisi dari PEMKAB pada tanggal <?= $tanggal_upload[8] != '' ? date("d/m/Y", $tanggal_upload[8]) : '-'; ?></th>
                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" id="pemeriksa9" name="pemeriksa9" value="<?= $user['nama']; ?>">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <div class="input-group input-group-sm">
                                <?php if ($dokumen['file9'] != null) : ?>
                                    <input type="text" readonly class="form-control text-center" id="keterangan9" name="keterangan9" placeholder="..." value="<?= set_value('keterangan9'); ?>">
                                    <input type="text" readonly class="form-control text-center" id="statusuraian9" name="statusuraian9" placeholder="..." value="<?= set_value('statusuraian9'); ?>">
                            ...
                            <small class="form-text text-danger"><?= $validation->getError('keterangan9'); ?></small>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="tanggal_review9" name="tanggal_review9" value=<?= time(); ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil verifikasi Persyaratan 9 baru!">
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive">
                <table class="table table-hover table-bordered table-sm" id="reviewfiles9">
                    <thead>
                    ...
                    <tbody>
                        <?php foreach ($rfiles as $rf) : ?>
                            <tr id="reviewers9" data-ket="<?= $rf['atrketerangan']; ?>" data-sta="<?= $rf['atrstatusuraian']; ?>">
