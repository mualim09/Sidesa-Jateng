        ...
        <div class="col-lg-12">
            ...
            <table class="table table-borderless table-sm" style="overflow-x:auto;">
                <?php foreach ($geturaian as $gu) : ?>
                    <tr>
                        <th width="68%">Diupload dari Pemkab pada tanggal <?= $tanggal_upload[4] != '' ? date("d/m/Y", $tanggal_upload[4]) : '-'; ?></th>
                        <th style=" text-align: left;" width="30px">Desa</th>
                        <th style=" text-align: left;" width="10px">:</th>
                        <th style=" text-align: left;"><?= $gu['desa']; ?></th>
                    </tr>
                    <tr>
                        <th width="68%">Direvisi dari PEMKAB pada tanggal <?= $tanggal_upload[4] != '' ? date("d/m/Y", $tanggal_upload[4]) : '-'; ?></th>
                ...
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" id="pemeriksa5" name="pemeriksa5" value="<?= $user['nama']; ?>">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <div class="input-group input-group-sm">
                                <?php if ($dokumen['file5'] != null) : ?>
                                    <input type="text" readonly class="form-control text-center" id="keterangan5" name="keterangan5" placeholder="..." value="<?= set_value('keterangan5'); ?>">
                                    <input type="text" readonly class="form-control text-center" id="statusuraian5" name="statusuraian5" placeholder="..." value="<?= set_value('statusuraian5'); ?>">
                            ...
                            <small class="form-text text-danger"><?= $validation->getError('keterangan5'); ?></small>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="tanggal_review5" name="tanggal_review5" value=<?= time(); ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil verifikasi Persyaratan 5 baru!">
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive">
                <table class="table table-hover table-bordered table-sm" id="reviewfiles5">
                    <thead>
                    ...
                    <tbody>
                        <?php foreach ($rfiles as $rf) : ?>
                            <tr id="reviewers5" data-ket="<?= $rf['atrketerangan']; ?>" data-sta="<?= $rf['atrstatusuraian']; ?>">
