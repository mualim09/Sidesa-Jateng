<div class="container-fluid">
    ...
    <h1 class="h4 text-gray mb-4 text-center">Daftar dokumen dan tinjauan lapangan TMTKD yang telah diverifikasi</h1>
    <div class="row justify-content-center mb-4">
        <div class="col-md-6">
            <form action="<?= base_url('sitkd/accmenu/accdokumen/'); ?>" method="post">
                <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                <div class="input-group mt-2">
                    <input type="text" class="form-control" placeholder="Cari data dokumen review.." name="keywordacc" autocomplete="off" autofocus>
            ...
            <tbody>
                ...
                <?php foreach ($getacc as $v) : ?>
                    <tr>
                        ...
                        <td align="center" style="vertical-align: middle;"><?= $v['kategori']; ?></td>
                        ...
                        <td align="center" style="vertical-align: middle;"><?= date("d/m/Y", $v['tanggal']); ?></td>
