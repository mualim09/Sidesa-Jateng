        ...
        <div class="col-lg-12">
            ...
            <table class="table table-borderless table-sm" style="overflow-x:auto;">
                <?php foreach ($geturaian as $gu) : ?>
                    <tr>
                        <th width="68%">Diupload dari Pemkab pada tanggal <?= date("d/m/Y", $tanggal_upload[9]); ?></th>
                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" id="pemeriksa10" name="pemeriksa10" value="<?= $user['nama']; ?>">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <div class="input-group input-group-sm">
                                <input type="text" readonly class="form-control text-center" id="keterangan10" name="keterangan10" placeholder="..." value="<?= set_value('keterangan10'); ?>">
                                <input type="text" readonly class="form-control text-center" id="statusuraian10" name="statusuraian10" placeholder="..." value="<?= set_value('statusuraian10'); ?>">
                            ...
                            <small class="form-text text-danger"><?= $validation->getError('keterangan10'); ?></small>
                        ...
                        <div class="form-group" <?php if ($catatan_member[9] == "") : ?> hidden <?php endif; ?>>
                            <label for="catatan">Catatan dari Kabupaten</label>
                            <textarea class="form-control" disabled name="catatan_member" id="catatan_member" style="font-style: italic;" rows="4"><?= $catatan_member[9]; ?></textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="tanggal_review10" name="tanggal_review10" value=<?= time(); ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil verifikasi Persyaratan 10 baru!">
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive">
                <table class="table table-hover table-bordered table-sm" id="reviewfiles10">
                    <thead>
                    ...
                    <tbody>
                        <?php foreach ($rfiles as $rf) : ?>
                            <tr id="reviewers10" data-ket="<?= $rf['atrketerangan']; ?>" data-sta="<?= $rf['atrstatusuraian']; ?>">
