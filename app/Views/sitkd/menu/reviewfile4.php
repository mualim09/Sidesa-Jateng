        ...
        <div class="col-lg-12">
            ...
            <table class="table table-borderless table-sm" style="overflow-x:auto;">
                <?php foreach ($geturaian as $gu) : ?>
                    <tr>
                        <th width="68%">Diupload dari Pemkab pada tanggal <?= date("d/m/Y", $tanggal_upload[3]); ?></th>
                        <th style=" text-align: left;" width="30px">Desa</th>
                        <th style=" text-align: left;" width="10px">:</th>
                        <th style=" text-align: left;"><?= $gu['desa']; ?></th>
                    </tr>
                    <tr>
                        <th width="68%">Direvisi dari PEMKAB pada tanggal <?php if ($tanggal_revisi[3] != "") : ?><?= date("d/m/Y", $tanggal_revisi[3]); ?><?php else : ?> - <?php endif; ?></th>
            ...
            <div class="card">
                <div class="card-header">
                    <dl class="row">
                        ...
                        <dd class="col text-right" style="<?php if ($statusuraian[3] == "sukses") : ?> color:#00cc00 <?php elseif ($statusuraian[3] == "revisi") : ?> color:red <?php else : ?> color:black <?php endif; ?>" class="text-right"><i><?= $statusuraian[3]; ?></i>
                        </dd>
                    </dl>
                </div>
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" id="pemeriksa4" name="pemeriksa4" value="<?= $user['nama']; ?>">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <div class="input-group input-group-sm">
                                <input type="text" readonly class="form-control text-center" id="keterangan4" name="keterangan4" placeholder="..." value="<?= set_value('keterangan4'); ?>">
                                <input type="text" readonly class="form-control text-center" id="statusuraian4" name="statusuraian4" placeholder="..." value="<?= set_value('statusuraian4'); ?>">
                            ...
                            <small class="form-text text-danger"><?= $validation->getError('keterangan4'); ?></small>
                        ...
                        <div class="form-group" <?php if ($catatan_member[3] == "") : ?> hidden <?php endif; ?>>
                            <label for="catatan">Catatan dari Kabupaten</label>
                            <textarea class="form-control" disabled name="catatan_member" id="catatan_member" style="font-style: italic;" rows="4"><?= $catatan_member[3]; ?></textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="tanggal_review4" name="tanggal_review4" value=<?= time(); ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil verifikasi Persyaratan 4 baru!">
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive">
                <table class="table table-hover table-bordered table-sm" id="reviewfiles4">
                    <thead>
                    ...
                    <tbody>
                        <?php foreach ($rfiles as $rf) : ?>
                            <tr id="reviewers4" data-ket="<?= $rf['atrketerangan']; ?>" data-sta="<?= $rf['atrstatusuraian']; ?>">
