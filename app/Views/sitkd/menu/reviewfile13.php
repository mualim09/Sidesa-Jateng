        ...
        <div class="col-lg-12">
            ...
            <table class="table table-borderless table-sm" style="overflow-x:auto;">
                <?php foreach ($geturaian as $gu) : ?>
                    <tr>
                        <th width="68%">Diupload dari Pemkab pada tanggal <?= date("d/m/Y", $tanggal_upload[12]); ?></th>
                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" id="pemeriksa13" name="pemeriksa13" value="<?= $user['nama']; ?>">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <div class="input-group input-group-sm">
                                <input type="text" readonly class="form-control text-center" id="keterangan13" name="keterangan13" placeholder="..." value="<?= set_value('keterangan13'); ?>">
                                <input type="text" readonly class="form-control text-center" id="statusuraian13" name="statusuraian13" placeholder="..." value="<?= set_value('statusuraian13'); ?>">
                            ...
                            <small class="form-text text-danger"><?= $validation->getError('keterangan13'); ?></small>
                        ...
                        <div class="form-group" <?php if ($catatan_member[12] == "") : ?> hidden <?php endif; ?>>
                            <label for="catatan">Catatan dari Kabupaten</label>
                            <textarea class="form-control" disabled name="catatan_member" id="catatan_member" style="font-style: italic;" rows="4"><?= $catatan_member[12]; ?></textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="tanggal_review13" name="tanggal_review13" value=<?= time(); ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil verifikasi Persyaratan 13 baru!">
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive">
                <table class="table table-hover table-bordered table-sm" id="reviewfiles13">
                    <thead>
                    ...
                    <tbody>
                        <?php foreach ($rfiles as $rf) : ?>
                            <tr id="reviewers13" data-ket="<?= $rf['atrketerangan']; ?>" data-sta="<?= $rf['atrstatusuraian']; ?>">
