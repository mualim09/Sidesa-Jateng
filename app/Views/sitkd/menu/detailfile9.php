    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="embed-responsive embed-responsive-16by9" style="height:800px;">
                <iframe src="<?= base_url('data/sitkd/file/laporanpdf/' . $dokumen['file9']) ?>" allowfullscreen></iframe>
            </div>
            <hr>
        </div>
        <!-- kolom side Widget -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" readonly class="form-control" value="<?php if ($pemeriksa[8] != "") : ?><?= $pemeriksa[8]; ?><?php else : ?> Belum diverifikasi PEMKAB <?php endif; ?>">
                    </div>
                    <div class="form-group">
