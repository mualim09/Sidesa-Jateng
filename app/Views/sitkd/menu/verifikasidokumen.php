<div class="container-fluid table-responsive">
    ...
    <h1 class="h4 text-gray text-center">Daftar dokumen dan tinjauan lapangan TMTKD Provinsi Jawa Tengah</h1>
    <div class="row justify-content-center mb-4 mt-4">
        <div class="col-md-6">
            <form action="<?= base_url('sitkd/menu/verifikasidokumen') ?>" method="post">
                <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                <div class="input-group mt-2">
                    <input type="text" class="form-control" placeholder="Cari data dokumen.." name="keywordmenu" autocomplete="off" autofocus>
    ...
    <table>
        <tr>
            ...
            <td>
                <a class="nav-link" href="<?= base_url('sitkd/menu/hapussessionkey'); ?>">
                ...
                <?php foreach ($verifikasi as $v) : ?>
                    <tr>
                        ...
                        <td style="vertical-align: middle;" align="center">
                            <a href="<?= base_url('sitkd/menu/detailuraian'); ?>/<?= $v['file_id']; ?>/<?= $v['tanggal']; ?>" class="badge badge-primary">detail</a>
                            <a href="<?= base_url('sitkd/menu/tracking'); ?>/<?= $v['file_id']; ?>" class="badge badge-dark">tracking</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
