<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <a href="<?= base_url('sitkd/menu/detailuraian'); ?>/<?= $dokumen['file_id']; ?>/<?= $dokumen['tanggal']; ?>" class="float-right mt-1"><i class="fas fa-fast-backward"> <em>Back to detail uraian</em></i></a>
            <p class="lead">
            ...
            <table class="table table-borderless table-sm" style="overflow-x:auto;">
                <?php foreach ($geturaian as $gu) : ?>
                    <tr>
                        <th width="68%">Diupload dari Pemkab pada tanggal <?= date("d/m/Y", $tanggal_upload[14]); ?></th>
                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" readonly class="form-control" id="pemeriksa14" name="pemeriksa14" value="<?= $pemeriksa[13]; ?>">
                            <input type="text" readonly class="form-control" id="pemeriksa15" name="pemeriksa15" value="<?= $user['nama']; ?>">
                            <input type="hidden" readonly class="form-control" id="pemeriksa16" name="pemeriksa16" value="<?= $pemeriksa[15]; ?>">
                        </div>
                        <div class="form-group mb-5">
                            <label>Keterangan</label>
                            <div class="input-group input-group-sm">
                                <input type="text" readonly class="form-control text-center" id="keterangan15" name="keterangan15" placeholder="..." value="<?= set_value('keterangan15'); ?>">
                                <input type="text" readonly class="form-control text-center" id="statusuraian15" name="statusuraian15" placeholder="..." value="<?= set_value('statusuraian15'); ?>">
                            ...
                            <small class="form-text text-danger"><?= $validation->getError('keterangan15'); ?></small>
                            ...
                            <input type="hidden" id="statusuraian14" name="statusuraian14" value=<?= $statusuraian[13]; ?>>
                            <input type="hidden" id="statusuraian16" name="statusuraian16" value=<?= $statusuraian[15]; ?>>
                        </div>
                        <div class="form-group" <?php if ($catatan_member[14] == "") : ?> hidden <?php endif; ?>>
                            <label for="catatan">Catatan dari Kabupaten</label>
                            <textarea class="form-control" disabled name="catatan_member" id="catatan_member" style="font-style: italic;" rows="4"><?= $catatan_member[14]; ?></textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="tanggal_review14" name="tanggal_review14" value=<?= $tanggal_review[13]; ?>>
                            <input type="hidden" class="form-control" id="tanggal_review15" name="tanggal_review15" value=<?= time(); ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil verifikasi Persyaratan 15 baru!">
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive">
                <table class="table table-hover table-bordered table-sm" id="reviewfiles15">
                    <thead>
                    ...
                    <tbody>
                        <?php foreach ($rfiles as $rf) : ?>
                            <tr id="reviewers15" data-ket="<?= $rf['atrketerangan']; ?>" data-sta="<?= $rf['atrstatusuraian']; ?>">
