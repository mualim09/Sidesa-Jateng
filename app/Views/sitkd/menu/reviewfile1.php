                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" id="pemeriksa1" name="pemeriksa1" value="<?= $user['nama']; ?>">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <div class="input-group input-group-sm">
                                <input type="text" readonly class="form-control text-center" id="keterangan1" name="keterangan1" placeholder="..." value="<?= set_value('keterangan1'); ?>">
                                <input type="text" readonly class="form-control text-center" id="statusuraian1" name="statusuraian1" placeholder="..." value="<?= set_value('statusuraian1'); ?>">
                            ...
                            <small class="form-text text-danger"><?= $validation->getError('keterangan1'); ?></small>
                        ...
                        <div class="form-group" <?php if ($catatan_member[0] == "") : ?> hidden <?php endif; ?>>
                            ...
                            <textarea class="form-control" disabled name="catatan_member" id="catatan_member" style="font-style: italic;" rows="4"><?= $catatan_member[0]; ?></textarea>
                        </div>
                        <div class="form-group">
                            <input type="hidden" class="form-control" id="tanggal_review1" name="tanggal_review1" value=<?= time(); ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" readonly class="form-control-plaintext" name="jenisnotif" id="jenisnotif" value="Hasil verifikasi Persyaratan 1 baru!">
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive">
                <table class="table table-hover table-bordered table-sm" id="reviewfiles1">
                    <thead>
                    ...
                    <tbody>
                        <?php foreach ($rfiles as $rf) : ?>
                            <tr id="reviewers1" data-ket="<?= $rf['atrketerangan']; ?>" data-sta="<?= $rf['atrstatusuraian']; ?>">
