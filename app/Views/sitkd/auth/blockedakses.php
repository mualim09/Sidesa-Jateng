...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column" style="position:relative; min-height: 800px;">
            ...
            <div class="container-fluid mt-5">
                ...
                <div class="col-lg-12">
                    <div class="text-center mb-12">
                        ...
                        <p class="lead text-gray-800 mb-5">Access Not Allowed</p>
                        <p class="text-gray-500 mb-0">Akses tidak diizinkan...</p>
                    </div>
                </div>
