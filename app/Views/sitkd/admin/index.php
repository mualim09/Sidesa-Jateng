    ...
    <div class="row text-white" style="justify-content: center;">
        <div class="card bg-primary" style="width: 16rem;">
            <div class="card-body">
                ...
                <a href="<?= base_url('sitkd/admin/role') ?>" style="text-decoration: none;">
        ...
        <div class="card bg-danger ml-3" style="width: 16rem;">
            <div class="card-body">
                ...
                <form action="<?= base_url('sitkd/excel/rekapadmin') ?>" method="get">
                    <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                    <div class="form-group" style="width: 6rem;">
                        <select class="custom-select" id="tahunsukses" name="tahunsukses">
                            <?php foreach ($gettahundokumensukses as $gts) : ?>
                                <option value="<?= $gts['tahun_sukses']; ?>"><?= $gts['tahun_sukses']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
