<div class="container-fluid">
    ...
    <div class="row justify-content-center mb-4">
        <div class="col-md-6">
            <form action="<?= base_url('sitkd/admin/role'); ?>" method="post">
        ...
        <div class="col table-responsive">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <a class="nav-link" href="<?= base_url('sitkd/admin/hapussessionkeyword'); ?>">
                ...
                <tbody>
                    ...
                    <?php foreach ($getrole as $gr) : ?>
                        <tr>
                            ...
                            <td align="center">
                                <a href="<?= base_url('sitkd/admin/roleedit/' . $gr['user_id']) ?>" class="badge badge-info">Edit</a>
                                <a href="<?= base_url('sitkd/admin/roleaccess/' . $gr['role_id']) ?>" class="badge badge-warning">Permission</a>
                                <a href="<?= base_url('sitkd/admin/hapususer/' . $gr['user_id']) ?>" class="badge badge-danger" onclick="return confirm('Konfirmasi user akan dihapus dari SITKD?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
