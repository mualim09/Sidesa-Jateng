...
class Pemkab extends BaseController
{
    ...
    function danadesa($kode)
    {
        ...
        $data = [
            ...
            'salur_bulanan_danadesa_reguler' => $this->Kabupaten5a_model->salur_reguler($kode),
            'salur_bulanan_danadesa_bltdd' => $this->Kabupaten5a_model->salur_bltdd($kode),
            'salur_bulanan_danadesa_kph' => $this->Kabupaten5a_model->salur_kph($kode),
            'salur_bulanan_danadesa_covid' => $this->Kabupaten5a_model->salur_covid($kode),
