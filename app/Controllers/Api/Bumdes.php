...
class Bumdes extends BaseController
{
    ...
    public function index()
    {
        ...
        if ($kd_kab === null && $kd_kec === null && $kd_des === null && $tahun === null) {
            $bumdes = $this->Api_model->getBumdes();
        } else if (isset($kd_kab)) {
            $bumdes = $this->Api_model->getBumdes($kd_kab);
        } else if (isset($kd_kec)) {
            $bumdes = $this->Api_model->getBumdesKec($kd_kec);
        } else if (isset($kd_des)) {
            $bumdes = $this->Api_model->getBumdesDes($kd_des);
        } else if (isset($tahun)) {
            $bumdes = $this->Api_model->getBumdesTahun($tahun);
        }
